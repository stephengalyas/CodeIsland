...
public class MCCollisionHandlerScriptForest : MonoBehaviour {
	...
	void OnTriggerStay2D(Collider2D coll)
    {
        ...
        else if (coll.gameObject.name == "mushroom") // The main character's speed needs to be doubled.
        {
            if (Input.GetKey(KeyCode.Space)) // The main character wants to pick up the berry.
            {
        ...
        else if(coll.gameObject.name == "endLvlCollider") // The main character has collided with the final object (ON LAYER 0).
        {
