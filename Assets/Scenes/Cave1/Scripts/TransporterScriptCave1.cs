 ...
 * This script handles the transportation of the main character around the Cave level.
*/
...
public class TransporterScriptCave1 : MonoBehaviour {
    ...
    /// <summary>
    /// Depending on the collision, move the character to another position on the Cave.
    /// </summary>
    /// <param name="coll">The collider.</param>
    void OnTriggerEnter2D(Collider2D coll)
    {
        if (wait == 150) // If we have given the main character enough time to move away from the collider.
        {
