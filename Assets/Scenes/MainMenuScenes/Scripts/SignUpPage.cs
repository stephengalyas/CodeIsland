...
public class SignUpPage : MonoBehaviour {
    ...
    void OnGUI()
    {
        ...
        GUI.Label(new Rect(Screen.width * placementXForStrings, Screen.height * .77f, Screen.width * .2f, Screen.height * .08f), errorMessage, errorStyle);
    ...
    private void CreateAccount()
    {
        ...
        if(checkAcct == true)
        {
            errorMessage = "This account's username already exists. Please try again.";
        }
        else // The account does not already exist.
        {
            ...
            errorMessage = "Account is created!";
        }
    }
}
